...
#import "AYGPUImageColorConversion.h"

//Optionally override the YUV to RGB matrices
void setAYColorConversion601( GLfloat conversionMatrix[9] );
void setAYColorConversion601FullRange( GLfloat conversionMatrix[9] );
void setAYAYColorConversion709( GLfloat conversionMatrix[9] );


//Delegate Protocal for Face Detection.
@protocol AYGPUImageVideoCameraDelegate <NSObject>
...
/**
 A AYGPUImageOutput that provides frames from either camera
*/
@interface AYGPUImageVideoCamera : AYGPUImageOutput <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
    ...
    BOOL capturePaused;
    AYGPUImageRotationMode outputRotation, internalRotation;
    dispatch_semaphore_t frameRenderingSemaphore;
        
    BOOL captureAsYUV;
    GLuint luminanceTexture, chrominanceTexture;

    __unsafe_unretained id<AYGPUImageVideoCameraDelegate> _delegate;
}
...
@property(nonatomic, assign) id<AYGPUImageVideoCameraDelegate> delegate;
