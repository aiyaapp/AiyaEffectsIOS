 ...
 */
@protocol AYGPUImageMovieDelegate <NSObject>
 ...
 */
@interface AYGPUImageMovie : AYGPUImageOutput
 ...
 */
@property (readwrite, nonatomic, assign) id <AYGPUImageMovieDelegate>delegate;
...
- (void)enableSynchronizedEncodingUsingMovieWriter:(AYGPUImageMovieWriter *)movieWriter;
