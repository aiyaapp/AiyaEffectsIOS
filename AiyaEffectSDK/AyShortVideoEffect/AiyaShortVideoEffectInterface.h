#ifndef __EFFECT_SHORTVIDEO_EFFECT_INTERFACE_H__
#define __EFFECT_SHORTVIDEO_EFFECT_INTERFACE_H__
#include <string>
#include <memory>
template <typename T>
...
//////////////////////////////////////////////////////////////////////////
class IEffect;
class EXPORT AiyaShortVideoEffect {
public:
	/*
	* instance create method
	* @param type: effect type, see ...
	*/
	static AiyaShortVideoEffect* Create( int type );
	/*
	* destroy method
	* @param effect: pointer to instance created by Create method
	*/
	static void Destroy( AiyaShortVideoEffect*& effect );
	/*
...
public:
	~AiyaShortVideoEffect( );

private:
	AiyaShortVideoEffect( );

private:
	friend void Statistic( AiyaShortVideoEffect* );
