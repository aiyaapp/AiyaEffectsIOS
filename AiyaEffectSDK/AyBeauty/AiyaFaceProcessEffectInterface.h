#ifndef __EFFECT_FACE_PROCESS_EFFECT_INTERFACE_H__
#define __EFFECT_FACE_PROCESS_EFFECT_INTERFACE_H__
#include <string>
#include <memory>
template <typename T>
...
//////////////////////////////////////////////////////////////////////////
class IEffect;
class EXPORT AiyaFaceProcessEffect {
public:
	/*
	* instance create method
	* @param type: effect type, see ...
	*/
	static AiyaFaceProcessEffect* Create( int type );
	/*
	* destroy method
	* @param effect: pointer to instance created by Create method
	*/
	static void Destroy( AiyaFaceProcessEffect*& effect );
	/*
...
public:
	~AiyaFaceProcessEffect( );

private:
	AiyaFaceProcessEffect( );

private:
	friend void Statistic( AiyaFaceProcessEffect* );
