#ifndef __EFFECT_BEAUTY_EFFECT_INTERFACE_H__
#define __EFFECT_BEAUTY_EFFECT_INTERFACE_H__
#include <string>
#include <memory>
template <typename T>
...
//////////////////////////////////////////////////////////////////////////
class IEffect;
class EXPORT AiyaBeautyEffect {
public:
	/*
	* instance create method
	* @param type: effect type, see ...
	*/
	static AiyaBeautyEffect* Create( int type );
	/*
	* destroy method
	* @param effect: pointer to instance created by Create method
	*/
	static void Destroy( AiyaBeautyEffect*& effect );
	/*
...
private:
	friend void Statistic( AiyaBeautyEffect* );
