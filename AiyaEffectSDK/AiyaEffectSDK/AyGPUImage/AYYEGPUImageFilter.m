...
NSString *const kAYYEGPUImageVertexShaderString = SHADER_STRING
(
...
NSString *const kAYYEGPUImagePassthroughFragmentShaderString = SHADER_STRING
(
...
@implementation AYYEGPUImageFilter
...
- (id)initWithContext:(AYYEGPUImageContext *)context vertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation = kAYYEGPUImageNoRotation;
...
{
    if (!(self = [self initWithContext:context vertexShaderFromString:kAYYEGPUImageVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
{
    if (!(self = [self initWithContext:context fragmentShaderFromString:kAYYEGPUImagePassthroughFragmentShaderString]))
    {
		return nil;
    }
...
+ (const GLfloat *)textureCoordinatesForRotation:(AYYEGPUImageRotationMode)rotationMode;
{
    ...
    switch(rotationMode)
    {
        case kAYYEGPUImageNoRotation: return noRotationTextureCoordinates;
        case kAYYEGPUImageRotateLeft: return rotateLeftTextureCoordinates;
        case kAYYEGPUImageRotateRight: return rotateRightTextureCoordinates;
        case kAYYEGPUImageFlipVertical: return verticalFlipTextureCoordinates;
        case kAYYEGPUImageFlipHorizonal: return horizontalFlipTextureCoordinates;
        case kAYYEGPUImageRotateRightFlipVertical: return rotateRightVerticalFlipTextureCoordinates;
        case kAYYEGPUImageRotateRightFlipHorizontal: return rotateRightHorizontalFlipTextureCoordinates;
        case kAYYEGPUImageRotate180: return rotate180TextureCoordinates;
    }
}
...
- (void)informTargetsAboutNewFrameAtTime:(CMTime)frameTime;
{
    ...
    for (id<AYYEGPUImageInput> currentTarget in targets)
    {
...
- (CGSize)rotatedSize:(CGSize)sizeToRotate forIndex:(NSInteger)textureIndex;
{
    ...
    if (AYYEGPUImageRotationSwapsWidthAndHeight(inputRotation))
    {
